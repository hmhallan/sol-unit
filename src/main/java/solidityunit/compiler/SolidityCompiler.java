...
*
* Adapted from: https://github.com/web3j/web3j-maven-plugin/blob/master/src/main/java/org/web3j/mavenplugin/solidity/SolidityCompiler.java
...
public class SolidityCompiler {
   ...
   private Logger LOG = LoggerFactory.getLogger(SolidityCompiler.class);
